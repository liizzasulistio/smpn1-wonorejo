...
<div class="card-body">
<h3><?= $activity['ActivityTitle'] ?></h3><hr>
    <div class="row" style="max-height: 400px; overflow: hidden;">
         ...
         <?php else: ?>
                <img src="<?= base_url('./images/'.$activity['ActivityImage']) ?>" class="mx-auto d-block" style="margin-top:2px; " class="bd-placeholder-img rounded-circle">    
        <?php endif; ?></div>

    <div class="row mt-2">
        <p><?=$activity['UserName']?></p>
        <p><?=$activity['updated_at']?></p>
        <p class="d-flex justify-content-between my-3" style="max-width: 100px;"><?= $activity['ActivityText'] ?></p>
    </div>
</div>
...
<div class="col-12 d-grid gap-2 d-md-flex justify-content-md-end mb-2">
    <a href="/admin/kegiatan/update/<?= $activity['slug'] ?>" class="btn btn-warning">Ubah</a>
 ...
 <div class="modal fade" id="deleteActivity" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteActivity" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-footer">
            ...
            <a href="/delete-activity/<?= $activity['ActivityID']?>" class="btn btn-danger">Hapus</a>
        </div></div></div>
    </div>
</div>
