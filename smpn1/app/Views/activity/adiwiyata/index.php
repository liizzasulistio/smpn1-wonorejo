...
<div class="pb-3">
    <div class="container text-center">
        <h1 style="font-family: 'Roboto', sans-serif; margin-top: 130px;" class="mb-3">Adiwiyata</h1>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            <div class="col">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a class="stretched-link" href="<?= base_url('/detail-adiwiyata'); ?>" style="color:black; text-decoration: none;"> Card title </a></h5>
